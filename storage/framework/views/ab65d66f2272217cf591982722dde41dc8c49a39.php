<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <?php echo Form::model($publicacion, ['route'=> ['publicaciones.update', $publicacion->id], 'method'=>'PUT']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php $__currentLoopData = $profesores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profesor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"  value="<?php echo e($profesor->id); ?>"  name="ids[]"  <?php if($publicacion->getProfesoresIds()->contains($profesor->id) == 1): ?> <?php echo e('checked'); ?> <?php endif; ?>>
...
<?php /* C:\Users\mario\crudwork\resources\views/publicaciones/edit.blade.php */ ?>