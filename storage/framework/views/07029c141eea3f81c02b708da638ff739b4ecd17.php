<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>['profesores.store'], 'method'=>'POST']); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('year') ? ' has-error' : ''); ?>">
                            ...
                            <?php echo Form::text('year', null, ['class'=>'form-control input-lg', 'placeholder'=>'Año de contratacion del profesor', 'value'=>old('year')]); ?>
...
<?php /* C:\Users\mario\crudwork\resources\views/profesores/create.blade.php */ ?>